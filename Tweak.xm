...
%ctor {
	%init;
	ADNTPrefsLoad();
	CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)ADNTPrefsUpdate, CFSTR("ws.hbang.notitoggle/ReloadPrefs"), NULL, 0);
}
